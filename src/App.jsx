...
export default function App() {
  ...
  return (
    <div className="flex flex-col items-center text-center w-full">
      ...
      <p className="max-w-[40%]">Thank you so much for celebrating with us! We would love it if you could share some of the special moments that we couldn't see ourselves.<br /><br /> This application is designed for ease, so no login required! Note that photos <span className="font-bold">cannot be deleted</span> (however, we can delete them ourselves later). Some video or image formats may not display correctly in the gallery, but if you see a placeholder image in the gallery, we have received it and will be able to view it later!</p><br />
